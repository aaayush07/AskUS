...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
   ...
   <form class="navbar-form navbar-left" name = "vinform">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href ="AddQuestion.jsp">Add A Question</a>
 ...
 <% 
 	...
 	PreparedStatement ps = con.prepareStatement("Select * from Question order by date desc LIMIT 10");
 	...
 	while(rs.next()){ 
 		...
 		while(rs1.next()){ 
 			...
 			<% 
 			out.println("<a role='menuitem' tabindex='-1' href= 'SearchResult.jsp?search= "+ obj.getAnswerWriterName(rs1.getInt(5)) + " '>");%>
...
var url="SrchQuestion.jsp?val="+v;  
